...
static char selbordercolor[]        = "#e3a857";
static char selbgcolor[]            = "#e3a857";
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,         XK_w,      spawn,      	   {.v = discord } },
	/* { MODKEY|ShiftMask,		XK_w,		spawn,		SHCMD("") }, */
	{ MODKEY,			XK_e,		spawn,		SHCMD("rofi -show drun -location 1 -width 560 -columns 2 -show-icons -yoffset 21") },
	...
	{ ShiftMask,			XK_Prior,	spawn,		SHCMD("maimpick") },
