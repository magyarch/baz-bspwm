...
myManageHook = composeAll . concat $
    ...
    my2Shifts = []
    my3Shifts = ["subl3"]
    my4Shifts = ["discord", "telegram-desktop"]
    my5Shifts = ["Gimp", "feh"]
    my6Shifts = ["vlc", "mpv"]
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_d), spawn $ "dmenu_run -fn Monospace-13" )
  , ((modMask, xK_f), sendMessage $ Toggle NBFULL)
  , ((modMask, xK_h), spawn $ "$TERMINAL -e htop" )
  , ((modMask, xK_m), spawn $ "spotify" )
  , ((modMask, xK_q), kill )
  , ((modMask, xK_r), spawn $ "$TERMINAL -n $FILE -c $FILE -e $FILE" )
  ...
  , ((modMask, xK_F9), spawn $ "dmenumount" )
  , ((modMask, xK_F10), spawn $ "dmenuumount" )
